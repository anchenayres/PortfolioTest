<?php
namespace BizzElements\Modules\Elementor;
...
class Module extends Module_Base {
	...
	public function register_controls_sticky($section, $section_id, $args) {
		...
		$section->add_control(
			'section_sticky_on',
			[
				'label'        => esc_html__( 'Enable Sticky', 'biz-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'description'  => esc_html__( 'Enable sticky sidebar?.', 'biz-elements' ),
			]
		);
		...
		//parallax
		$section->start_controls_section(
			'section_parallax_controls',
			[
				'label' => __( 'Parallax Bakground', 'biz-elements' ),
				'tab' => Controls_Manager::TAB_ADVANCED,
			]
		);
		...
		$section->add_control(
			'section_parallax_on',
			[
				'label'        => esc_html__( 'Enable Paralax Background', 'biz-elements' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
	...
	public function sticky_before_render($section) {    		
		...
		//parallax background
		if( !empty($settings[ 'section_parallax_on' ]) == 'yes' ) {
			
			
			if ( !empty($settings[ 'section_parallax_on' ] == 'yes' ) ) {
				$sticky_option = 'cww-parallax';
			}
