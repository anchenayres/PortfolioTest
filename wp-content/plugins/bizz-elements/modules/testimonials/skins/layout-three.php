...
class Layout_Three extends Elementor_Skin_Base {
    ...
    public function get_title() {
        return __( 'Layout Three', 'bizz-elements' );
    }
    ...
    public function render() {
        ...
        $this->parent->add_render_attribute( 'cww-wrapp', 'class', 'cww-testimonials layout-three' );
        ?>
        ...
        <div class="testimonial-wrapp">
            ...
            foreach( $settings['cww_test_rep_data'] as $item ){ ?>
                <div class="inner-wrapp">
                    <div class="test-desc">
                        <?php echo esc_html($item['cww_test_desc']); ?>
                    </div>
        ...
        if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
            ...
            jQuery( document ).ready( function( $ ) {
                ...
                $('.cww-testimonials.layout-three .testimonial-wrapp').slick({
                    infinite: true,
                    slidesToShow: 3,
                    slidesToScroll: 3,
                    arrows: true,
