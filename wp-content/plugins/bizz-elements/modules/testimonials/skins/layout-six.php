...
class Layout_Six extends Elementor_Skin_Base {
    ...
    public function get_title() {
        return esc_html__( 'Layout Six', 'bizz-elements' );
    }
    ...
    public function render() {
        ...
        $this->parent->add_render_attribute( 'cww-wrapp', 'class', 'cww-testimonials layout-six' );
        ?>
        ...
        if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
            ...
            jQuery( document ).ready( function( $ ) {
               ...
               $('.cww-testimonials.layout-six .testimonial-wrapp').slick({
                    infinite: true,
                    slidesToShow: 3,
                    slidesToScroll: 3,
                    dots: true,
