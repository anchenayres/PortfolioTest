...
class Layout_Four extends Elementor_Skin_Base {
    ...
    public function get_title() {
        return esc_html__( 'Layout Four', 'bizz-elements' );
    }
    ...
    public function render() {
        ...
        $this->parent->add_render_attribute( 'cww-wrapp', 'class', 'cww-testimonials layout-four' );
        ?>
        ...
        if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
            ...
            jQuery( document ).ready( function( $ ) {
               ...
               $('.cww-testimonials.layout-four .testimonial-wrapp').slick({
                    infinite: true,
                    slidesToShow: 1,
                    slidesToScroll: 1,
                    arrows: true
