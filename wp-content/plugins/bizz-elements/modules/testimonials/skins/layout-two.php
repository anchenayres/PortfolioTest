...
class Layout_Two extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Layout Two', 'bizz-elements' );
	}
	...
	public function render() {
        ...
        $this->parent->add_render_attribute( 'cww-wrapp', 'class', 'cww-testimonials layout-two' );
        ?>
        ...
        <?php
         ...
         if ( \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
            ...
            jQuery( document ).ready( function( $ ) {
               ...
               $('.cww-testimonials.layout-two .testimonial-wrapp').slick({
                    infinite: true,
                    slidesToShow: 1,
                    slidesToScroll: 1,
                    dots: false,
