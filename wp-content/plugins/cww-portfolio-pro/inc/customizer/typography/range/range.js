wp.customize.controlConstructor["cww-portfolio-pro-range"] = wp.customize.Control.extend({
    ready: function () {
        "use strict";
        ...
        jQuery("input[type=range]")
            ...
            .on("input", function () {
                ...
                range.siblings("input.cww-portfolio-pro-range-input").attr("value", value);
            });

        // Change the text value
        jQuery("input.cww-portfolio-pro-range-input")
            .off()
            .on("input", function () {
        ...
        jQuery(".cww-portfolio-pro-reset-slider")
            .off()
            .on("click", function () {
